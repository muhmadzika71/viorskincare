          ...
          <div className="col-span-12 md:col-span-6 flex flex-col justify-between px-6 md:px-12 lg:px-16 py-14 md:py-20 text-white">
            <div>
              ...
              <Reveal delay={3} className="mt-10 flex flex-wrap items-center gap-4">
                <Link href="/contact" className="btn-pill text-white pl-6 pr-2 py-2 rounded-full inline-flex items-center gap-3" style={{ background: 'var(--coral)' }}>
          ...
          <div className="col-span-12 md:col-span-6 relative min-h-[480px] md:min-h-[88vh]">
            <Reveal className="absolute inset-0">
              <div className="w-full h-full relative overflow-hidden">
                <Image src="/vior_hero_model.png" alt="Hero photograph" fill className="object-cover" priority sizes="50vw" />
                ...
                <div className="absolute top-6 left-6 chip" style={{ background: 'rgba(255,255,255,0.92)', color: 'var(--ink)', borderColor: 'transparent' }}>
                  <span className="dot" style={{ background: 'var(--coral)', opacity: 1 }}/> Bestseller · Micellar Water
                </div>
                ...
                <div className="absolute bottom-6 right-6 rounded-2xl p-4 w-[240px]" style={{ background: '#fff', boxShadow: '0 18px 40px -16px rgba(74,35,90,0.45)' }}>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full overflow-hidden relative flex-shrink-0" style={{ background: 'var(--surface)' }}>
                      <Image src="/vior_micellar_water.png" alt="Micellar Water" fill className="object-contain p-1" sizes="40px" />
                    </div>
                    <div>
                      <div className="text-[13px] font-medium leading-tight" style={{ color: 'var(--ink)' }}>Micellar H2O</div>
                      <div className="font-mono text-[10px] tracking-[0.14em] uppercase text-[color:var(--ink-soft)]">Cleanser · 200 ml</div>
                    </div>
                  </div>
                  <div className="mt-3 flex items-center justify-between">
                    <div className="font-display text-lg" style={{ color: 'var(--ink)' }}>$32</div>
                    <Link href="/contact?product=HYALURONIC+MICELLAR+H2O+Ultra" className="btn-pill text-xs text-white rounded-full px-3 py-1.5" style={{ background: 'var(--coral)' }}>Order</Link>
                  </div>
                </div>
